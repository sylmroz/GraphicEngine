...
#include "../Services/ServicesManager.hpp"
...
namespace GraphicEngine
{
	...
	{
	public:
		RenderingEngine(std::shared_ptr<Services::ServicesManager> servicesManager,
	...
	protected:
		std::shared_ptr<Services::ServicesManager> m_servicesManager;
