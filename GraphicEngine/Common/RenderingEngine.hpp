...
#include "../Engines/Graphic/3D/ObjectGenerators/CylinderGenerator.hpp"
#include "../Engines/Graphic/3D/ObjectGenerators/ConeGenerator.hpp"
...
namespace GraphicEngine
{
	...
	public:
			...
			m_cfg(cfg)
		{
			...
			//auto cylinder = Engines::Graphic::CylindeRgenerator<Common::VertexPN>{}.getModel(glm::vec3(0.0f), 1.0f, 2.0f, glm::ivec3(20, 5, 2), Engines::Graphic::TriangleDirection::CounterClockwise);
