...
namespace GraphicEngine
{
	...
	public:
		RenderingEngine(std::shared_ptr<Services::CameraControllerManager> cameraControllerManager,
			...
			m_cfg(cfg)
		{
			auto cylinder = Engines::Graphic::ConeGenerator<decltype(m_models)::value_type::element_type::vertex_type>{}.getModel(glm::vec3(0.0f), 0.5f, 2.0f, glm::ivec3(20, 2, 2), false, true, Engines::Graphic::TriangleDirection::CounterClockwise);
